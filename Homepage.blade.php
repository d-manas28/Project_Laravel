...
@section('header')
    <header>
        <nav class="nav-wrapper transparent">
            ...
            <ul class="backg1">                
                <li><a href="account" class="white-text">Account</a></li>
                <li><a href="#secondsection" class="white-text">Get Started</a></li>
                <li><a href="update" class="white-text">View Status</a></li>
                <li><a href="update" class="white-text">Update Status</a></li>
                ...
                <div class="card-content center">
                    <div class="form-field">
                        <button class="btn-large red darken-1 z-depth-5 center-align">
                            <a href="processpage" style="text-decoration:none;color:white;">
                            ADD PROCESS NOW
                            </a>
                        </button>  
                    </div><br>
